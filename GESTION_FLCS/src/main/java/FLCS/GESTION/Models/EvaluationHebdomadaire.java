...
public class EvaluationHebdomadaire extends BaseEntity {
    ...
    public enum Statut {
        BROUILLON, VALIDE, ANNULE, SAISI
    }

    @Transient
    public Double getMoyenne() {
        double somme = (noteLesen != null ? noteLesen : 0.0) + (noteHoren != null ? noteHoren : 0.0)
                + (noteSchreiben != null ? noteSchreiben : 0.0) + (noteGrammatik != null ? noteGrammatik : 0.0)
                + (noteSprechen != null ? noteSprechen : 0.0);
        return somme / 5;
    }
    ...
    public void validateNotes() {
        if (noteLesen != null && (noteLesen < 0 || noteLesen > 20) ||
                noteHoren != null && (noteHoren < 0 || noteHoren > 20) ||
                noteSchreiben != null && (noteSchreiben < 0 || noteSchreiben > 20) ||
                noteGrammatik != null && (noteGrammatik < 0 || noteGrammatik > 20) ||
                noteSprechen != null && (noteSprechen < 0 || noteSprechen > 20)) {
